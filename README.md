...
<a href="https://github.com/muddasir03/Deliveroo-clone-ReactNative/blob/main/package.json" target="_blank">🔶 Dependency Info</a>
...
```bash
  git clone https://github.com/muddasir03/Deliveroo-clone-ReactNative.git
```
